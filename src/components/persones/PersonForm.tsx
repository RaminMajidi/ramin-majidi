...
const PersonForm: React.FC<PersonFormProps> = ({
  ...
  // تابع ensureRequiredFields را در کامپوننت PersonForm اصلاح کنید:
  const ensureRequiredFields = (
    ...
    if (type === "NATURAL") {
      ...
      result.passport_number = null; // به جای ""
      ...
      result.legal_establishment_date = null; // مهم: برای تاریخ null بفرست
    } else if (type === "LEGAL") {
  ...
  const getFieldsToValidateByType = (
    type: CreatePersonDto["typ"]
